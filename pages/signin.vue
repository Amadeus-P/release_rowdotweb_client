        ...
        <section style="display: flex; flex-wrap: wrap; width: auto; margin: 10px;">
            ...
            <form @submit.prevent="localLoginHandler">
                ...
                <label style="position: relative;">
                    ...
                    <input :type="isShowPassword ? 'text' : 'password'" v-model="password" autocomplete="off"
                        required />
            ...
            <div class="text-hidden"
                style="position: relative; border: none; border-top: 1px solid var(--base-color-3); margin: 50px 0 10px 0; width: 100%;">
                구분선</div>
            <div style="display: flex; justify-content: center; margin-top: 20px; width: 100%;">
                <NuxtLink class=""
                    style="font-size: var(--font-size-3); font-weight: var(--font-weight-6); cursor: pointer;"
                    to="/signup">회원이 아니라면</NuxtLink>
            </div>
        </section>
    </main>
</template>
